module ShantiIntegration
  class Engine < ::Rails::Engine
    initializer :assets do |config|
      Rails.application.config.assets.paths << root.join('vendor', 'assets', 'images', 'jquery.draggable').to_s
      ...
      Rails.application.config.assets.precompile.concat(['jquery.draggable/*.gif','jquery.draggable/*.png'])
